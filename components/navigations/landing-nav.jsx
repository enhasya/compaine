...
const LandingNav = () => {
  ...
  return (
    <nav className="bg-[#F8F8FF]/10 lg:fixed top-0 z-10 flex flex-col lg:flex-row gap-8 lg:gap-4 items-center justify-between w-full h-auto backdrop-blur-lg p-8 lg:px-32 lg:py-4">
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-0 items-start lg:items-center justify-center lg:justify-start w-full lg:w-[40%]">
        ...
        {expandLandingNav && (
          <React.Fragment>
            <button className="bg-transparent text-black transition-all hover:text-[#3000E6] lg:hover:text-black lg:hover:bg-white flex flex-row gap-2 items-center rounded-lg w-full lg:w-auto p-0 lg:px-4 lg:py-2">
